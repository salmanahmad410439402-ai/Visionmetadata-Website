        ...
        <div ref={featRef as React.RefObject<HTMLDivElement>}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map(({ icon: Icon, title, desc }, i) => (
              <div key={title}
                className={`reveal reveal-delay-${Math.min(i % 4 + 1, 6)} rounded-2xl p-6 transition-all duration-300 glass-panel group hover:-translate-y-1 hover:border-primary hover:shadow-[0_0_30px_hsl(var(--primary)/0.25)]`}>
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 bg-primary/10 border border-primary/20 group-hover:bg-primary/20 group-hover:border-primary/50 group-hover:shadow-[0_0_15px_hsl(var(--primary)/0.3)] transition-all">
          ...
          <div className="reveal mt-8 glass-panel rounded-2xl p-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <div key={label} className="flex flex-col items-center px-4 py-2.5 rounded-xl transition-all glass-panel group hover:-translate-y-1 hover:border-primary hover:shadow-[0_0_20px_hsl(var(--primary)/0.2)]">
