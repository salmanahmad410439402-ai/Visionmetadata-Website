...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      scrolled
        ? "glass-panel rounded-b-3xl mx-2 mt-2 sm:mx-6 sm:mt-4 shadow-2xl shadow-primary/10"
        : "bg-transparent"
    }`}>
      <div className="max-w-7xl mx-auto px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {/* Download CTA */}
          <a href="https://github.com/salmangraphics839-hue/visionmeta-releases/releases/download/1.3.5/VisionMetadata.Pro_1.3.5_x64-setup.exe" target="_blank" rel="noopener noreferrer"
        ...
        {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden glass-panel rounded-2xl mx-2 mt-2 p-6 animate-in fade-in slide-in-from-top-2 duration-300 shadow-2xl">
          {navLinks.map((link) => (
