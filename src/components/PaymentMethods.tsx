    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="pt-8 pb-16 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="reveal inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6 accent-indigo-light accent-indigo-border-soft">
        ...
        <div className="reveal reveal-delay-3 grid md:grid-cols-2 gap-6 mb-12">
          {methods.map(({ icon: Icon, name, desc, details, color }, idx) => (
            <div key={name} className={`reveal reveal-delay-${(idx % 4) + 1} glass-panel rounded-2xl p-7 overflow-hidden group hover:-translate-y-1 hover:border-primary hover:shadow-[0_0_35px_hsl(var(--primary)/0.30)] transition-all duration-300`}>
              
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-primary/10 border border-primary/20 group-hover:bg-primary/20 group-hover:border-primary/50 group-hover:shadow-[0_0_15px_hsl(var(--primary)/0.3)] transition-all">
        ...
        {/* Info Box */}
        <div className="reveal glass-panel rounded-2xl p-6 text-center border-primary/20">
